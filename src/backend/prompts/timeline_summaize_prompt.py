...
# Rules
1. CoD Summary: Extract overarching core insights (NOT timeline-based). ≤{max_words} words. Iterate {iterations} times, adding {entity_range} tech entities/step. Fuse ALL entities. Cut fillers. Use KR Markdown.
2. Timeline: 4-8 concept-based chapters. Start: "MM:SS". Title: "1. KR_Title".
3. Output: STRICT minified JSON ONLY. Zero meta-text.

{{"summary":"<use \n for line breaks and Markdown>","timeline":[{{"start":"MM:SS","title":"1. KR_Title"}}]}}
"""
